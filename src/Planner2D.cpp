...
PYBIND11_MODULE(planner2d, m)
{
    ...
    py::class_<EMPlanner2D::Parameter>(m, "EMPlannerParameter")
        ...
        .def_readwrite("uncertainty_weight", &EMPlanner2D::Parameter::uncertainty_weight)
        .def_readwrite("occupancy_weight", &EMPlanner2D::Parameter::occupancy_weight)
        .def_readwrite("delta_angle_weight", &EMPlanner2D::Parameter::delta_angle_weight)
        .def_readwrite("entropy_weight", &EMPlanner2D::Parameter::entropy_weight)
        .def_readwrite("trajectory", &EMPlanner2D::Parameter::trajectory)
